...
nlp_result_path=os.path.join(ff_path,'resultNlp2.0')
env = sys.argv[1]
# 生产
url1="http://ai.haier.net:11000/"+env+"/ai-access/nlp?engine="
...
async def fileTraverse(files,num):
    ...
    isExit=commonMethods.write_result1(flag_dict, result_dict, flag_reason_dict,nlp_excel_path, file, nlp_result_path,exit,nlp_version_dict)
